        ...
        <header>
            <div class="image-text">
                ...
                <div class="text logo-text">
                    <span class="name">ECA <span style="color: #019455">Assurance</span></span>
                        ...
                        text-align: center;">
                            <table >
                                <tr style="font-size: 12px">
                                    ...
                                    <th style="padding:4px; border-right:1px solid black">Départ</th>
                                </tr>
                                
                                <tr>
                                    
                                    <td style="font-size: 12px ; ">{{$userCounts['Autorisé']}}</td>
                                    <td style="font-size: 12px ; ">{{$userCounts['Restreint']}}</td>
