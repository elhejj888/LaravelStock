...
Route::get('/searchMaterial', [MaterialController::class, 'searchMaterial'])->name('searchMaterial');//Search in the Materials web page using Ajax
Route::get('assignMaterial/{materialId}/{userId}', [MaterialController::class, 'assignMaterial'])->name('assignMaterial');//assignig the material with materialID to the user with userID
